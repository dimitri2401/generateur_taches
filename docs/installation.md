...
- Cloner le répertoire Git ou le télécharger depuis GitHub.
- Recommandé : créer un environnement virtuel Python dans le répertoire.
- Veiller à installer toutes les dépendances `pip install -r requirements.txt`. Attention, un compilateur C++ doit être configuré sur la machine afin de pouvoir compiler la bibliothèque `highspy`.